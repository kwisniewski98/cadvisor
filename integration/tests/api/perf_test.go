...
func TestPerfEvents(t *testing.T) {
	...
	assert.Greater(t, len(info.Stats[0].Perf.PerfStats), 0, "Length of info.Stats[0].Perf.PerfStats is not greater than zero")
	for k, stat := range info.Stats[0].Perf.PerfStats {
